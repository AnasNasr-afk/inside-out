...
class MoodCheckInCard extends StatefulWidget {
  ...
  const MoodCheckInCard({super.key, required this.childName});
...
class _MoodCheckInCardState extends State<MoodCheckInCard> {
  ...
  final List<_MoodOption> _moods = const [
    ...
    _MoodOption(emoji: '😤', label: 'Frustrated'),
  ];
  ...
  Widget build(BuildContext context) {
    return AnimatedSwitcher(
      ...
      child: _submitted ? _buildConfirmed() : _buildCheckIn(),
    );
  }
